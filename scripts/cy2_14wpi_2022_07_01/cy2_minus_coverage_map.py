...
for hit in hits:
    hsps_with_minus_hit_strands = list(filter(has_minus_hit_strand, hit.hsps))
    ps = get_covered_hit_positions(hsps_with_minus_hit_strands)
