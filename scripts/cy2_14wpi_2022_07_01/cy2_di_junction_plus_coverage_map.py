"""
Produces a coverage map of CY2 genome sequence taking into account hits
containing the DI-RNA junction of 671 to 2703 and are "Plus" hit strand.
"""
...
for hit in hits:
    ...
    # if hit_to is 671 and hit_from is 2703, then is "Plus" hit strand
    if len(hsps) >= 2 and hsps[0].hit_to == 671 and hsps[1].hit_from == 2703:
